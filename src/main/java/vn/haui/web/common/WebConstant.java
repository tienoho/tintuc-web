...
public class WebConstant {
    ...
    public static String localHost = "http://thoitrangvietnam.tk";
    public static int categorySubOne = 4;
    public static int postView = 4;
    public static String blogdescription = "Website tin tức jsp";
    public static String blogname = "Website tin tức jsp";
    public static String comment = "false";
    public static String xImagePath_icon = "/images/share.png";
    public static String xImagePath_logo = "/images/sm-logo-1.png";
